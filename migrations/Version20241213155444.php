 ...
 */
final class Version20241213155444 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE posts ALTER name TYPE VARCHAR(80)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE posts ALTER name TYPE VARCHAR(255)');
    }
}
